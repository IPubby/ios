...
@interface ArticleProvider : NSObject<NSCoding>
...
/// Whether or not the provider has more articles available to load.
///
/// @return
///     YES if there are more articles available; NO otherwise.
///
- (BOOL)hasMoreArticles;

/// Loads more articles from the next page of results if available.
///
