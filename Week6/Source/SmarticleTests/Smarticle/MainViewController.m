...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    if ([[segue destinationViewController] isKindOfClass:[ListViewController class]])
    {
        ...
        {
            listViewController.title = @"Most Viewed";
            listViewController.articles = [[ArticleProvider alloc] initWithArticleType:ArticleTypeMostViewed];
        }
        else if (sender == self.mostEmailedButton)
        {
            listViewController.title = @"Most Emailed";
            listViewController.articles = [[ArticleProvider alloc] initWithArticleType:ArticleTypeMostEmailed];
        }
        else if (sender == self.mostSharedButton)
        {
            listViewController.title = @"Most Shared";
            listViewController.articles = [[ArticleProvider alloc] initWithArticleType:ArticleTypeMostShared];
        }
        else
        {
            listViewController.title = @"Favorites";
            listViewController.articles = [[FavoritesArticleProvider alloc] init];
        }
    }
}
